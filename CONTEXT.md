...
Контрольные ID, созданные в ходе этих проб (для последующего cleanup): групповые классы `2355017` («English A2 (demo)», учитель Zhanna, ученики Anna/Viktor/Dmitry) и `2355018` («English B1 (demo)», учитель Kirill, ученики Boris/Galina); групповые уроки `29459865` и `29459866` (English A2, 2026-08-23/24 16:00 UTC), `29459871` и `29459872` (English B1, 2026-08-23/24 17:00 UTC), все по 60 минут. Записи подлежат удалению через `ScheduleDeleteLesson` и `GroupClassesDelete` после Gate B.
