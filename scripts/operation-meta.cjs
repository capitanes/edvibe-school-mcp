...
const OPERATION_META = {
  ...
  GroupClassPupilsAdd: { description: "Add pupils to a group class." },
  ...
  PupilsDelete: { description: "Delete a pupil.", warning: "Destructive: removes the pupil. Requires client-side approval." },
